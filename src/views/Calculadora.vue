  ...
  import { decodeState } from '../utils/stateManager';
  ...
  <template>
    <div class="min-h-screen bg-gray-100 py-8">
      <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow">
          ...
          <div v-if="showSecondMatrix">
            <div class="mb-4 flex gap-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  v-model.number="colsB"
                  min="1"
                  max="10"
                  :disabled="operation === 'add' || operation === 'subtract'"
                  class="w-20 p-1 border rounded"
                />
              </div>
            </div>
        ...
        <MatrixSteps
          v-if="showSteps && result.length"
          :matrix-a="matrixA"
          :matrix-b="showSecondMatrix ? matrixB : undefined"
          :operation="operation"
          :result="result"
        />
      </div>
